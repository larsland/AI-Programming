...
if __name__ == '__main__':
    ...
    ann1 = ANN(cases, test_cases, [50], [Tann.softplus, Tann.softplus, Tann.softmax], 0.005, 50, 1, 10, 'sum')
    #ann2 = ANN(cases, test_cases, [50], [Tann.softplus, Tann.softplus, Tann.softmax], 0.01, 50, 1, 10, 'mean')
