...
class VCProblem:
    ...
    def get_input(self):
        ...
        # n_list = [self.make_var(l, s) for l, s in [print(wat.split()) for wat in ls[1:nv+1]]]
...
class VCProblem:
    ...
    def get_input(self):
        ...
        num_vertices, num_edges = map(int, graph[0].split())
        self.create_nodes(num_vertices, graph, K)
        self.set_constraints(num_vertices, graph, con=lambda n: n[0] != n[1], description="n[0] != n[1]")
"""